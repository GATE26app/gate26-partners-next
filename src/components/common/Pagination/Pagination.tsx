...
function Pagination({
    ...
    return (
        <PageContainer alignItems="center" justifyContent="center">
            <Flex className="page-button left" alignItems="center" justifyContent="center" onClick={() => onPreviousPageClicked(currentPage - 1)}>
                <ArrowLeftIcon maxH="24px" maxW="24px" width="2em" height="2em" />
            </Flex>
            <Flex gap="20px" className="page-items">
                {renderNumbers()}
            </Flex>
            <Flex className="page-button right" alignItems="center" justifyContent="center" onClick={() => onNextPageClicked(currentPage + 1)} >
